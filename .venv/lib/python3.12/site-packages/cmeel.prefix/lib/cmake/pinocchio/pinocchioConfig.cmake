...
set("pinocchio_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("PINOCCHIO_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
...
set("_pinocchio_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_pinocchio_PKG_CONFIG_LIBS_LIST" "-lpinocchio_default -lpinocchio_parsers -lboost_filesystem")
if(_pinocchio_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_pinocchio_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _pinocchio_PKG_CONFIG_LIBS_LIST "${_pinocchio_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_pinocchio_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _pinocchio_PKG_CONFIG_LIBS_LIST "${_pinocchio_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_pinocchio_PKG_CONFIG_LIBDIR})
  foreach(component ${_pinocchio_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_pinocchio_PKG_CONFIG_LIBS_LIST)
...
if(${CMAKE_VERSION} VERSION_LESS "3.15.0")
  ...
  find_dependency(urdfdom REQUIRED)
  find_dependency(Boost REQUIRED COMPONENTS filesystem serialization)
  find_dependency(hpp-fcl REQUIRED)
endif()
...
foreach(component ${pinocchio_FIND_COMPONENTS})
  ...
  if(pinocchio_${component}_FOUND)
    ...
    if(pinocchio_FIND_REQUIRED_${component})
      message(FATAL_ERROR "pinocchio: ${component} not found.")
    else()
