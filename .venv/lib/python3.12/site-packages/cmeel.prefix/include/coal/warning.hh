...
//
// #pragma message COAL_WARN("your warning message here")
//
...
# define COAL_WARN_STRINGISE(x) \
         COAL_WARN_STRINGISE_IMPL(x)
# ifdef __GNUC__
#   define COAL_WARN(exp) ("WARNING: " exp)
# else
#  ifdef _MSC_VER
#   define FILE_LINE_LINK __FILE__ "(" \
           COAL_WARN_STRINGISE(__LINE__) ") : "
#   define COAL_WARN(exp) (FILE_LINE_LINK "WARNING: " exp)
#  else
